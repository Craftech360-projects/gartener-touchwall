    ...
    <div className="w-screen h-screen">
      ...
      <div className=" w-[80vw] h-[70vh] flex justify-center gap-32 items-center absolute top-[16%] left-[10%] rounded-[20px] border backdrop-blur-lg bg-white/30">
        <div className="w-[17%] flex justify-center items-center flex-col">
          <Link href={"https://www.dell.com/en-us/dt/case-studies-customer-stories/linde-china-internet-of-things.htm#collapse&pdf-overlay=//www.delltechnologies.com/asset/en-us/solutions/infrastructure-solutions/customer-stories-case-studies/dell-technologies-linde-china-customer-profile.pdf"} className="w-[300px] h-[300px] rounded-2xl" style={{backgroundImage: `url(${caseStudy2})`, backgroundSize:`cover`}}>
          </Link>
        ...
        <div className="w-[17%] flex justify-center items-center flex-col">
          <Link href={"https://www.dell.com/en-us/dt/case-studies-customer-stories/general-motors-high-performance-computing.htm#collapse"} className="w-[300px] h-[300px] rounded-2xl" style={{backgroundImage: `url(${caseStudy3})`, backgroundSize:`cover`}}>
          </Link>
        ...
        <div className="w-[17%] flex justify-center items-center flex-col">
          <Link href={"https://www.dell.com/en-us/dt/case-studies-customer-stories/hyundai-motor-group.htm#collapse"} className="w-[300px] h-[300px] rounded-2xl" style={{backgroundImage: `url(${caseStudy})`, backgroundSize:`cover`}}>
          </Link>
